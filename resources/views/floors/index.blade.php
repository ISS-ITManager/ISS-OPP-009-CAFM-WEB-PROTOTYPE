...
@section('content')
    <a href="/properties/show" class="btn btn-primary mb-3">
        <i class=" fa fa-angle-left me-2"></i> Main House
    </a>
    <div class="row mb-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <span class="badge bg-label-info mb-1">Floor </span> <br>
                            <span class="fw-bold text-primary h3">
                                Floor 1
                            </span> <br>
                           
                            <small> Nunnery / Main House / Floor 1</small>
                        </div>
                        <div class="col-md-3 ">
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-9">
                            <i class="bx bxs-flag text-info me-2 text-lg"></i> 
                            <span class="text-dark fw-bold">Zone</span>
                        </div>
                        <div class="col-3">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <a href="/zones" class="list-group-item d-flex justify-content-between align-items-center">
                            <span>Zone A</span>
