            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <span class="badge bg-label-info mb-1">Property </span> <br>
                            <span class="fw-bold text-primary h3">
                                Main House
                            </span> <br>
                           
                            <small> Nunnery / Main House /</small>
                        </div>
                        <div class="col-md-3 ">
        ...
        <div class="col-md-3">
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row">
                        <div class="col-9">
                            <i class="bx bxs-layer text-info me-2 text-lg"></i> 
                            <span class="text-dark fw-bold">Floors</span>
                        </div>
                        <div class="col-3">
                            <a href="#" class="btn btn-label-primary float-end"  data-bs-target="#create_floor" data-bs-toggle="modal">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <a href="/floors" class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
                        <div class="avatar avatar-lg">
                          <div class="avatar-initial bg-label-info rounded">
                            <h1 class="bx  bx-money mt-3 text-info" style="font-size: 45px;"></h1>
                          </div>
                        </div>
                        <div class="content-right">
                          <p class="mb-0 fw-medium">Total Income</p>
                          <h4 class="text-info mb-0">102</h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
                        <div class="avatar avatar-lg">
                          <div class="avatar-initial bg-label-danger rounded">
                            <h1 class="bx  bx-money mt-3 text-danger" style="font-size: 45px;"></h1>
                          </div>
                        </div>
                        <div class="content-right">
                          <p class="mb-0 fw-medium">Total Expenses</p>
                          <h4 class="text-danger mb-0">102</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="nav-align-top mb-6">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="navs-asset" role="tabpanel">
                        <a href="#" class="btn btn-primary mb-3" data-bs-target="#create_asset" data-bs-toggle="modal">
