...
@section('content')
    ...
    <a href="/zones" class="btn btn-primary mb-3">
        <i class=" fa fa-angle-left me-2"></i> Zone A
    </a>
    <div class="row mb-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <span class="badge bg-label-info mb-1">Space </span> <br>
                            <span class="fw-bold text-primary h3">
                                Space A
                            </span> <br>
                           
                           
                            <small> Nunnery / Main House / Floor 1 / Zone A / Space A</small>
                        </div>
                        <div class="col-md-3 ">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <a href="/rooms" class="list-group-item d-flex justify-content-between align-items-center">
                            <span>Room A</span>
