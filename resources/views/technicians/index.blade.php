...
@section('content')
    <a href="#" class="btn btn-primary mb-3">
        <i class="fa fa-plus me-2"></i> Create Techinician
    </a>
    <div class="card">
        <div class="card-header fw-bold text-primary">
            List of Techinicians
        </div>
        <div class="card-body">
